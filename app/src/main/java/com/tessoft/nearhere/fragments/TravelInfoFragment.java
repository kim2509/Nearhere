...
public class TravelInfoFragment extends BaseFragment {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        getActivity().registerReceiver(mMessageReceiver, new IntentFilter(Constants.BROADCAST_REFRESH_TRAVEL_INFO ));
    }
    ...
    private BroadcastReceiver mMessageReceiver = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            try
            {
                if ( intent.getAction().equals(Constants.BROADCAST_REFRESH_TRAVEL_INFO))
                    webView.reload();
            }
            catch( Exception ex )
            {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        try
        {
            ...
            if ( rootView == null )
            {
                ...
                webView.loadUrl(Constants.getServerURL() + "/travelInfo/index.do?isApp=Y"
